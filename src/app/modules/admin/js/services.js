...
angular.module('spBlogger.admin.services').value('API_ENDPOINT','http://104.236.237.125:8080/api/posts/:id');
angular.module('spBlogger.admin.services').value('AUTH_ENDPOINT','http://104.236.237.125:8080/login');
angular.module('spBlogger.admin.services').value('LOGOUT_ENDPOINT','http://104.236.237.125:8080/logout');
